$(document).ready(function(){
  ...
  /*Audio with text  ACTIVATE IF THE NEW ATTEMPT DOESN'T WORK*/
...
/*landing ACTIVATE IF IT DOESN'T WORK*/
...
/*pinned image0 OLD SISTEM DON'T ACTIVATEs*/
...
// parallaxTL
//   .from('#familyEzequiel .content-wrapper', 0.65, {autoAlpha: 0, ease:Power0.easeNone}, 1)
//   .from('#familyEzequiel .text-center', 0.8, {autoAlpha: 0, ease:Power0.easeNone}, 1)
//   .from('#familyEzequiel .bcg', 8, {y: '-50%', ease:Power0.easeNone}, 0)
//   ;
//
...
//   .from('#Ricardo .bcg', 2, {y: '-50%', ease:Power0.easeNone}, 0)
//   ;
//
// var slideParallaxScene = new ScrollMagic.Scene({
...
/*sections transitions ACTIVATE IF IT DOESN'T WORK*/
...
/*Fit images in fullscreen ACTIVATE IF IT DOESN'T WORK*/
//
...
// }
  ...
  /*map path drawing ACTIVATE IF IT DIDN'T WORK*/
...
/*arbeit gallery ACTIVATE IF IT DIDN'T WORK*/
...
/*until here*/
  ...
  /*small animation single images ACTIVATE IF IT DIDN'T WORK*/
  //
  // var lastScrollTop = 0;
  //
  // $(window).on('load resize scroll', function() {
...
/*my own pinning attempt ACTIVATE IF IT DIDN'T WORK*/
//
// $(window).on('load resize scroll', function() {
//
//   $.fn.hitsTop = function() {
